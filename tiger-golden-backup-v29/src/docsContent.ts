...
console.log("Tiger Extension: Docs Helper Loaded");
...
const checkAndShowOverlay = async () => {
    try {
        ...
        if (result.pendingSummaryPaste) {
            console.log("Tiger Extension: Pending paste found!");
            ...
            overlay.style.animation = 'tigerFadeIn 0.5s forwards';
        ...
        console.error("Tiger Extension Error:", e);
    }
};
