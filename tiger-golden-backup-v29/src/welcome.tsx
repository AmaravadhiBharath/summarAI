...
const Welcome = () => {
    ...
    useEffect(() => {
        const unsubscribe = subscribeToAuthChanges((u: ChromeUser | null) => {
            setUser(u);
            setLoading(false);
        });
        return () => unsubscribe();
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-4">
                                <div className="text-center space-y-1">
                                    ...
                                    <p className="text-2xl font-bold">Welcome, {user.name?.split(' ')[0]}!</p>
                                </div>
                                <div className="pt-4 space-y-3">
                                    <Button size="lg" className="w-full bg-black hover:bg-gray-800 text-white shadow-lg shadow-black/20" onClick={async () => {
                                        try {
                                            // @ts-ignore
                                            ...
                                            console.error(e);
                                            toast("Please click the Summarai icon in your toolbar!", { icon: '🧩' });
                                        }
                                    }}>
