                ...
                <div className="max-w-2xl mx-auto space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                        ...
                        <FAQItem
                            ...
                            answer="Summarai works on 24+ AI and development platforms: ChatGPT, OpenAI, Google Gemini, Google Labs, Figma, Visily, Uizard, UX Magic, Banani, Emergent, Rocket, Lovable, Bolt, Base44, Create XYZ, Memex, BuildFire, Glide, Flatlogic, Retool, UI Bakery, Zoho, Appy Pie, and more. We're constantly adding new platforms!"
                        />
                        <FAQItem
