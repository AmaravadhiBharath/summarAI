// Background service worker - IMMEDIATE WAKE UP
console.log("Service Worker: I am awake!");

// CRITICAL: Register message listener FIRST, before any other operations
// This prevents "Could not establish connection" errors on fresh installs
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    ...
    // Ensure we ALWAYS respond, even if it's just an acknowledgment
    try {
...
// Keep-Alive Listener (prevents service worker from sleeping during long operations)
